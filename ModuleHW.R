...
mad_libs <- function(...){
  ...
  paste("News from", place, "today where",
  adjective, "students took to the streets in protest of the new", 
...
flips2 <- rbinom(size = 1 , n = 100, prob = .7)
flips2
sum(flips2)
?rnorm
rnorm(10)
